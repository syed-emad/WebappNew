    ...
    return (
      <React.Fragment>
        <div className="container2">
          ...
          <p
            className="label100"
            style={{ fontSize: "30px", marginLeft: "10px", marginTop: "20px" }}
          >
      ...
      <div className="row">
        <div className="col-md-6 ">
          <div className="wrap-input100 validate-input">
            <label className=" label100 ml-3" htmlFor="firstname">
              First name:
            </label>
            <input
              className="input100"
        ...
        <div className="col-md-6 ">
          ...
          <div className="wrap-input100 validate-input">
            <label className=" ml-3 pt-4" htmlFor="zipCode">
              Zip Code:
            </label>
            <input
              className="input100"
  ...
  return (
    <div className="form-group mb-10px ">
      ...
      <div className="row">
        ...
        <label className="ml-3">Qualification:</label>
        <input
        ...
        <div className="col">
          <label className="ml-2">Subjects:</label>
          <input
    ...
    <React.Fragment>
      <div className="form-group mb-10px ">
        ...
        <label className="mb-3">
          Select days and time that you prefer to teach
        </label>
        <div className="row">
          <div className="col">
            <div className="form-group">
      ...
      <button className="login100-form-btn" onSubmit={props.handleSubmit}>
        Sign up
      </button>
    </React.Fragment>
  );
