            ...
            <div>
                 <div className="container">
                     ...
                     <div className="row" >
                        ...
                        <h1 style={{ fontFamily: "Montserrat",fontSize:"30px"}}>Education Details (Step {this.props.step})</h1>
                            <br />
                            <div>
                            ...
                            <label className=" ml-3" htmlFor="startDate">Start Date:</label>
                                ...
                                value={this.props.education[index].startDate}
                                onChange={handleChange(index)}
                                />
                            </div>
                            </div>
                            ...
                            <label className=" ml-3" htmlFor="endDate">End Date:</label>
                                ...
                                value={this.props.education[index].endDate}
                                onChange={handleChange(index)}
                                />
                            </div>
                            </div>
